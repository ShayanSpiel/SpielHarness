...
import {
  ...
  ArrowDown, ArrowUp, ArrowToBottom, ArrowToTop,
  ...
  Grid, Columns, Menu,
  Bold, Italic, Underline, FontColor, QuoteLeft, ListOl,
  ...
  Layers, LayersDownRight, Move, Brain, FolderOpen, Flask, MedicalFlask, BarChart, Robot,
...
const ICON_COMPONENTS: Record<string, React.ComponentType<BoxIconProps>> = {
  Search, SearchAlt, Plus, TrashAlt, Save, Check, X, Cog, Filter, Pencil,
  Copy, RefreshCw, RefreshCcw, LoaderDots, DotsHorizontalRounded,
  ArrowBigUp, ArrowBigDown, ArrowBigLeft, ArrowBigRight, ArrowRight, ArrowDown, ArrowUp,
