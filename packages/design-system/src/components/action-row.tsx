...
export const ActionRow = forwardRef<HTMLButtonElement, ActionRowProps>(function ActionRow(
  ...
  return (
    <button
      ...
      className={cn(
        "flex min-w-0 w-full rounded-md text-start transition-colors duration-[var(--duration)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] disabled:pointer-events-none disabled:text-[var(--disabled-foreground)]",
        compact ? "items-center gap-1.5 px-2 py-1" : "items-center gap-2.5 px-2.5 py-2",
