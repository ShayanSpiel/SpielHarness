...
import {
  ...
  Copy, RefreshCw, LoaderDots, DotsHorizontalRounded,
  ArrowBigUp, ArrowBigDown, ArrowBigLeft, ArrowBigRight, ArrowRight,
  ArrowUp,
  ChevronUp, ChevronDown, ChevronLeft, ChevronRight,
  File, Folder, FolderPlus, Image, Video, Music, LinkAlt,
  Envelope, MessageBubbleCaptions, Send, Bell,
  ...
  Timer, Calendar, MapIcon, Pin, Flag, TagAlt, Hashtag, At,
